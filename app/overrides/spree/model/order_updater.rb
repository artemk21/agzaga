...
module Spree
  class OrderUpdater
    ...
    def determine_shipment_state
      if order.state != 'canceled' && order.backordered?
        'backorder'
      else
    ...
    def update_shipment_total
      ...
      shipping_methods = shipments.map {|shipment| shipment.shipping_method.name}
      if shipping_methods.include?("Expedited Max 3 days")
        order.shipment_total = order.shipment_total < 149.99 ? order.shipment_total : 149.99
      else
        order.shipment_total = order.shipment_total < 99.99 ? order.shipment_total : 99.99
      end
      update_order_total
    end
...
# touched on 2025-07-09T17:33:45.913611Z
# touched on 2025-07-09T19:43:40.391238Z
# touched on 2025-07-09T19:44:04.075043Z